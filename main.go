...
func (r Running) Calories() float64 {
	return (CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * float64(r.Training.Weight) / MInKm * float64(r.Training.Duration.Hours()*MinInHours)
}
